//
//  NsampleTransform.cpp
//  latticeRCSP_v2
//
//  Created by Axel Parmentier on 03/11/2015.
...
namespace ResourceSample {
    ...
    void Nsample::expand(const ResourceSample::Nsample & b){
        ...
        transform(samplesValue.begin(), samplesValue.end(), b.getSampleBeginIterator(), samplesValue.begin(), plus<double>());
    }
